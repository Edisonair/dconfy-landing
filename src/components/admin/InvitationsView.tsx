...
import { Mail, Plus, CheckCircle2, Clock, Trash2 } from 'lucide-react';

export function InvitationsView({ handleInvite, newEmail, setNewEmail, isInviting, invitations, handleDeleteInvite }: any) {
    return (
            ...
            <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                    ...
                    <tbody className="divide-y divide-slate-800 text-sm font-medium">
                        {invitations.length === 0 ? <tr><td colSpan={4} className="px-8 py-16 text-center text-slate-500 font-medium">No hay invitaciones enviadas aún.</td></tr> : invitations.map((inv: any) => (
