      ...
      <section id="como-funciona" className="bg-white py-24 px-1 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col gap-20 max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
            <div className="order-1 md:order-1 max-w-sm mx-auto md:ml-auto md:mr-12 text-center md:text-left">
            ...
            <div className="order-2 md:order-2 max-w-[320px] mx-auto md:mr-auto md:ml-4 mix-blend-multiply hover:-translate-y-2 transition-transform duration-500">
          ...
          {/* Fila 2 */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
            <div className="order-2 md:order-1 max-w-[320px] mx-auto md:ml-auto md:mr-4 mix-blend-multiply hover:-translate-y-2 transition-transform duration-500">
            ...
            <div className="order-1 md:order-2 max-w-sm mx-auto md:mr-auto md:ml-12 text-center md:text-left">
