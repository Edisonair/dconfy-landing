      ...
      <section id="como-funciona" className="bg-white py-24 px-1 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col gap-20 max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
            <div className="order-1 md:order-1 max-w-sm mx-auto md:mx-0 md:justify-self-end text-center md:text-left">
            ...
            <div className="order-2 md:order-2 max-w-[320px] mx-auto md:mx-0 md:justify-self-start mix-blend-multiply hover:-translate-y-2 transition-transform duration-500">
          ...
          {/* Fila 2 */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
            <div className="order-2 md:order-1 max-w-[320px] mx-auto md:mx-0 md:justify-self-end mix-blend-multiply hover:-translate-y-2 transition-transform duration-500">
            ...
            <div className="order-1 md:order-2 max-w-sm mx-auto md:mx-0 md:justify-self-start text-center md:text-left">
          ...
          <div className="border-t border-slate-800 pt-16 grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            <div className="md:col-span-2">
              ...
              <div className="mt-6 flex items-center gap-3">
                ...
                <a href="https://www.tiktok.com/@dconfy" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center p-2 rounded-full bg-slate-800 hover:bg-[#FF6600] text-slate-400 hover:text-white transition-all group" aria-label="TikTok de dconfy">
