    ...
    <div className="min-h-screen bg-white selection:bg-violet-200">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative">
          <div className="max-w-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link onClick={() => track('Clic_Descargar_Hero')} href="#descargar" className="bg-[#F97316] hover:bg-[#EA580C] text-white px-8 py-3.5 rounded-full font-bold transition-all shadow-lg shadow-orange-200/50 text-center">
                Descargar app
              </Link>
              <Link onClick={() => track('Clic_Planes_Hero')} href="#planes" className="border-2 border-violet-600 text-violet-700 hover:bg-violet-50 px-8 py-3.5 rounded-full font-bold transition-all text-center">
      ...
      <section id="descargar" className="bg-[#FFF9F0] py-24 px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 items-center">
          ...
          {/* Botón App Store */}
          <button onClick={() => track('Clic_AppStore')} className="bg-[#171A21] hover:bg-[#222630] text-white px-5 py-2.5 rounded-[14px] flex items-center justify-start gap-3.5 transition-colors w-[200px] shadow-sm">
          ...
          {/* Botón Google Play */}
          <button onClick={() => track('Clic_GooglePlay')} className="bg-[#171A21] hover:bg-[#222630] text-white px-5 py-2.5 rounded-[14px] flex items-center justify-start gap-3.5 transition-colors w-[200px] shadow-sm">
      ...
      <section id="planes" className="bg-white py-24 px-6 max-w-7xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto text-left">
          ...
          <div className="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-lg hover:shadow-xl transition-shadow flex flex-col">
            ...
            <Link href="#descargar" onClick={() => track('Clic_Descargar_Planes')} className="block w-full text-center border-2 border-slate-200 text-slate-700 hover:border-[#F97316] hover:text-[#F97316] py-3.5 rounded-2xl font-bold transition-all">
              Descargar app
            </Link>
          </div>
          ...
          <div className="bg-[#171A21] p-8 rounded-[2rem] border border-slate-800 shadow-2xl relative transform md:-translate-y-4 hover:-translate-y-5 transition-transform flex flex-col text-white">
            ...
            <button
              onClick={() => {
                track('Clic_Contactar_Plan_Empresa');
